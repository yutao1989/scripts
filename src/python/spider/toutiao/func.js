...
function p(e, t) {
    var n, r, o = l(e),
        i = [],
        u = [];
    for (i[15] = u[15] = void 0, o.length > 16 && (o = s(o, 8 * e.length)), n = 0; 16 > n; n += 1) i[n] = 909522486 ^ o[n], u[n] = 1549556828 ^ o[n];
    return r = s(i.concat(l(t)), 512 + 8 * t.length), c(s(u.concat(r), 640))
}
...
function get() {
    var t = Math.floor((new Date).getTime() / 1e3),
        ...
        e = b(t).toString().toUpperCase();
    if (8 != i.length) return {
        as: "479BB4B7254C150",
        cp: "7E0AC8874BB0985"
    };
...
function extend(n) {
    ...
    2 > r || null == n)
        return n;
    for (var o = 1; r > o; o++)
        for (var i = arguments[o], u = eee(i), a = u.length, s = 0; a > s; s++) {
            var c = u[s];
...
var path = "/c/user/article/"

console.log(JSON.stringify(extend({},params,get())))
